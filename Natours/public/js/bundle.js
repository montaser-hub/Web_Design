...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9udGFzZXItaXNtYWlsIiwiYSI6ImNtNnA0cHM2YTE0NXUyc3M4bGloeGx4YnkifQ.Edjht61ggmep_GM72rVmbA';
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"updateSittings.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'passwords' ? 'http://127.0.0.1:3000/api/v1/users//updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCh',
            url: url,
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51QtWBvPF1f1XL63ttbSGrCZuimdTu2C9fL95VxsgnofNZ8gS6iVmzSySTZi9Uqad1k78CsGOwCFuAyA1Q5bbIfac00NoeFoIjx');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.showAlert)('Error processing your payment. Please try again!', _context.t0);
        case 13:
        case "end":
          return _context.stop();
      }
...
var _updateSittings = require("./updateSittings");
...
var userPassowrdForm = document.querySelector('.form-user-passowrd');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSittings.updateSettings)(form, 'data');
  });
}
if (userPassowrdForm) {
  userPassowrdForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var passowrdCurrent, passowrd, passowrdConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Updating....';
            passowrdCurrent = document.getElementById('passowrd-current').value;
            passowrd = document.getElementById('passowrd').value;
            passowrdConfirm = document.getElementById('passowrd-confirm').value;
            _context.next = 7;
            return (0, _updateSittings.updateSettings)({
              passowrdCurrent: passowrdCurrent,
              passowrd: passowrd,
